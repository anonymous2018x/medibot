...
// infections table
infections_addTip=["",spacer+"This option allows all members of the group to add records to the 'Infections' table. A member who adds a record to the table becomes the 'owner' of that record."];

infections_view0Tip=["",spacer+"This option prohibits all members of the group from viewing any record in the 'Infections' table."];
infections_view1Tip=["",spacer+"This option allows each member of the group to view only his own records in the 'Infections' table."];
infections_view2Tip=["",spacer+"This option allows each member of the group to view any record owned by any member of the group in the 'Infections' table."];
infections_view3Tip=["",spacer+"This option allows each member of the group to view all records in the 'Infections' table."];

infections_edit0Tip=["",spacer+"This option prohibits all members of the group from modifying any record in the 'Infections' table."];
infections_edit1Tip=["",spacer+"This option allows each member of the group to edit only his own records in the 'Infections' table."];
infections_edit2Tip=["",spacer+"This option allows each member of the group to edit any record owned by any member of the group in the 'Infections' table."];
infections_edit3Tip=["",spacer+"This option allows each member of the group to edit any records in the 'Infections' table, regardless of their owner."];

infections_delete0Tip=["",spacer+"This option prohibits all members of the group from deleting any record in the 'Infections' table."];
infections_delete1Tip=["",spacer+"This option allows each member of the group to delete only his own records in the 'Infections' table."];
infections_delete2Tip=["",spacer+"This option allows each member of the group to delete any record owned by any member of the group in the 'Infections' table."];
infections_delete3Tip=["",spacer+"This option allows each member of the group to delete any records in the 'Infections' table."];
...
// descriptions table
descriptions_addTip=["",spacer+"This option allows all members of the group to add records to the 'Descriptions' table. A member who adds a record to the table becomes the 'owner' of that record."];

descriptions_view0Tip=["",spacer+"This option prohibits all members of the group from viewing any record in the 'Descriptions' table."];
descriptions_view1Tip=["",spacer+"This option allows each member of the group to view only his own records in the 'Descriptions' table."];
descriptions_view2Tip=["",spacer+"This option allows each member of the group to view any record owned by any member of the group in the 'Descriptions' table."];
descriptions_view3Tip=["",spacer+"This option allows each member of the group to view all records in the 'Descriptions' table."];

descriptions_edit0Tip=["",spacer+"This option prohibits all members of the group from modifying any record in the 'Descriptions' table."];
descriptions_edit1Tip=["",spacer+"This option allows each member of the group to edit only his own records in the 'Descriptions' table."];
descriptions_edit2Tip=["",spacer+"This option allows each member of the group to edit any record owned by any member of the group in the 'Descriptions' table."];
descriptions_edit3Tip=["",spacer+"This option allows each member of the group to edit any records in the 'Descriptions' table, regardless of their owner."];

descriptions_delete0Tip=["",spacer+"This option prohibits all members of the group from deleting any record in the 'Descriptions' table."];
descriptions_delete1Tip=["",spacer+"This option allows each member of the group to delete only his own records in the 'Descriptions' table."];
descriptions_delete2Tip=["",spacer+"This option allows each member of the group to delete any record owned by any member of the group in the 'Descriptions' table."];
descriptions_delete3Tip=["",spacer+"This option allows each member of the group to delete any records in the 'Descriptions' table."];
