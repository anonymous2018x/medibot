...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"`class_time_table`.`category`" => "category"
	);
	...
	$x->QueryFrom = "`class_time_table` LEFT JOIN `infections` as infections1 ON `infections1`.`id`=`class_time_table`.`infection` LEFT JOIN `symptoms` as symptoms1 ON `symptoms1`.`id`=`class_time_table`.`symptom` ";
	$x->QueryWhere = '';
	$x->QueryOrder = '';
	...
	$x->ColCaption = array("Day", " Time Start", "Time End", "Unit code", "Venue", "Infection", "Symptom", "Category");
	$x->ColFieldName = array('day', 'time_start', 'time_end', 'unit_code', 'venue', 'infection', 'symptom', 'category');
