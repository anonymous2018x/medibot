...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"`student_details`.`category`" => "category",
	...
	$x->QueryFrom = "`student_details` LEFT JOIN `infections` as infections1 ON `infections1`.`id`=`student_details`.`infection` LEFT JOIN `symptoms` as symptoms1 ON `symptoms1`.`id`=`student_details`.`symptom` ";
	$x->QueryWhere = '';
	$x->QueryOrder = '';
	...
	$x->ColCaption = array("Full name", "Infection", "Symptom", "Category", "Reg no");
	$x->ColFieldName = array('full_name', 'infection', 'symptom', 'category', 'reg_no');
