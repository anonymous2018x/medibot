...
*/
	...
	$lookups = array(   
		...
		'symptoms' => array(   
			'infection' => array(
				'parent_table' => 'infections',
				'parent_pk_field' => 'id',
				'parent_caption' => '`infections`.`name`',
				'parent_from' => '`infections` ',
				'filterers' => array(),
				'custom_query' => '',
		...
		'class_time_table' => array(   
			...
			'symptom' => array(
				'parent_table' => 'symptoms',
				'parent_pk_field' => 'id',
				'parent_caption' => '`symptoms`.`name`',
				'parent_from' => '`symptoms` LEFT JOIN `infections` as infections1 ON `infections1`.`id`=`symptoms`.`infection` ',
				'filterers' => array('infection' => 'infection'),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
				'not_null' => true
