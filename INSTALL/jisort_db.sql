...
CREATE TABLE `class_time_table` (
  ...
  `infection` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `class_time_table` (`id`, `day`, `time_start`, `unit_code`, `venue`, `infection`, `symptom`, `category`, `time_end`) VALUES
...
INSERT INTO `symptoms` (`id`, `name`, `infection`) VALUES
...
INSERT INTO `exam_time_table` (`id`, `date`, `time_start`, `unit_code`, `venue`, `infection`, `symptom`, `category`, `time_end`) VALUES
...
(1, 2, 'infections', 1, 3, 3, 3),
(2, 2, 'symptoms', 1, 3, 3, 3),
...
(1, 'infections', '1', 'admin', 1543914528, 1543914528, 2),
(2, 'symptoms', '1', 'admin', 1543914679, 1543914679, 2),
(3, 'infections', '2', 'admin', 1543914710, 1543914710, 2),
(4, 'symptoms', '2', 'admin', 1543914732, 1543914732, 2),
...
(11, 'descriptions', '1', 'admin', 1543917355, 1543917355, 2),
(12, 'class_time_table', '4', 'koech', 1543929297, 1543929297, 4),
(13, 'descriptions', '2', 'koech', 1543929368, 1543929368, 4),
...
INSERT INTO `descriptions` (`id`, `description`, `infection`, `symptom`, `category`, `date`) VALUES
...
INSERT INTO `infections` (`id`, `name`) VALUES
(1, 'Education'),
(2, 'Science');
...
INSERT INTO `student_details` (`id`, `full_name`, `infection`, `symptom`, `category`, `reg_no`) VALUES
