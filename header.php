...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<title>Medibot | <?php echo (isset($x->TableTitle) ? $x->TableTitle : ''); ?></title>
		<link id="browser_favicon" rel="shortcut icon" href="<?php echo PREPEND_PATH; ?>resources/images/icon.png">
		<link rel="stylesheet" href="<?php echo PREPEND_PATH; ?>vendor/font-awesome/css/font-awesome.min.css">
