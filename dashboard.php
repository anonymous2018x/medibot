...
<head>
  ...
  <title>Medibot | Dashboard</title>
  <link id="browser_favicon" rel="shortcut icon" href="<?php echo PREPEND_PATH; ?>resources/images/icon.png">
  <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  <!-- Navigation-->
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav" style="background: #221;">
    <a class="navbar-brand" href="index.html">Medibot</a>
  ...
  <div class="content-wrapper" style="background: #333;">
    <div class="container-fluid">
      <h1 style="color: #fff"><strong class="navbar-brand ">MEDIBOT</strong><small class="lead">home to quick medical service</small></h1>
      <!-- Breadcrumbs-->
      <ol class="breadcrumb">
